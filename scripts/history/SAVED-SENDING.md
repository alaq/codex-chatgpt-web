...
Text must be non-empty and no larger than 12,000 UTF-8 bytes. The response has
...
Validation: seven sender tests plus the unchanged launcher ownership/control tests;
